...
enum class CTPOrderStatusType(
    ...
    PART_FILL_IN_QUEUE('1', "部分成交", "部分成交，剩余部分在等待成交", false),
    PART_FILL_NOT_IN_QUEUE('2', "部分成交", "部分成交，剩余部分已撤单", true),
    IN_QUEUE('3', "未成交", "报单已发送往交易所正在等待成交", false),
    NOT_IN_QUEUE('4', "未成交", "报单还未发往交易所", false),
