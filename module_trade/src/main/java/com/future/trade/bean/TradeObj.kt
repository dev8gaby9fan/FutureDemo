...
data class RspAuthenticateField(
    var brokerID: String, var userID: String, var userProductInfo: String,
 ...
 * 查询确认结算单记录响应数据
 */
data class RspQrySettlementInfoConfirmField(
    var brokerID: String,
    ...
    companion object {
        fun fromCTPAPI(rsp: CThostFtdcSettlementInfoConfirmField?): RspQrySettlementInfoConfirmField? =
            if (rsp == null) null
            else RspQrySettlementInfoConfirmField(
                rsp.brokerID,
                rsp.investorID,
                rsp.confirmDate,
                rsp.confirmTime,
 ...
 * 查询确认结算单记录响应
 */
class RspQrySettlementInfoConfirm(var rspField: RspQrySettlementInfoConfirmField?, rspInfo: RspInfoField, bIsLast: Boolean) :
    APIRspTradeObj(rspInfo, bIsLast)

data class RspQrySettlementInfoField(
    var tradingDay: String,
    var settlementID: Int,
    var brokerID: String,
    var investorID: String,
    ...
    companion object {
        fun fromCTPAPI(rsp: CThostFtdcSettlementInfoLongField): RspQrySettlementInfoField =
            RspQrySettlementInfoField(
                rsp.tradingDay, rsp
                    .settlementID, rsp.brokerID, rsp.investorID, rsp.sequenceNo, rsp.content
            )
    }
}
 ...
 * 确认结算单响应
 */
class RspConfirmSettlementInfo(var rspField: RspQrySettlementInfoConfirmField?, rspInfo: RspInfoField, bIsLast: Boolean) :
    APIRspTradeObj(rspInfo, bIsLast)

/**
 * 查询资金响应数据
 */
data class RspTradingAccountField(
    var brokerID: String,
    var accountID: String,
    var preMortgage: Double,
    var preCredit: Double,
    var preDeposit: Double,
    var preBalance: Double,
    var preMargin: Double,
    var interestBase: Double,
    var interest: Double,
    var deposit: Double,
    var withDraw: Double,
    var frozenMargin: Double,
    var frozonCash: Double,
    var frozenCommission: Double,
    var currMargin: Double,
    var cashIn: Double,
    var commission: Double,
    var closeProfit: Double,
    var positionProfit: Double,
    var balance: Double,
    var avaliable: Double,
    var withDrawQuota: Double,
    var reserve: Double,
    var tradingDay: String,
    var settlementID: Int,
    var credit: Double,
    var mortgage: Double,
    var exchangeMargin: Double,
    var deliveryMargin: Double,
    var exchangeDeliveryMargin: Double,
    var reserveBalance: Double,
    var currencyID: String,
    var preFundMortgageIn: Double,
    var preFundMortgageOut: Double,
    var fundMortgageIn: Double,
    var fundMortgageOut: Double,
    var fundMortgageAvailable: Double,
    var mortgageableFund: Double,
    var specProductMargin: Double,
    var specProductFrozenMargin: Double,
    var specProductCommission: Double,
    var specProductFrozenCommission: Double,
    var specProductPositionProfit: Double,
    var specProductCloseProfit: Double,
    var specProductPositionProfitByAlg: Double,
    var specProductExchangeMargin: Double,
    var bizType: Char,
    var frozenSwap: Double,
    var remainSwap: Double
) {
    companion object {
        fun fromCPTAPI(rsp: CThostFtdcTradingAccountField?): RspTradingAccountField? =
            if (rsp == null) null
            else RspTradingAccountField(
                rsp.brokerID,
                rsp.accountID,
                rsp.preMortgage,
                rsp.preCredit,
                ...
                rsp.exchangeMargin,
                rsp.deliveryMargin,
                rsp.exchangeDeliveryMargin,
                rsp.reserveBalance,
                rsp.currencyID,
                rsp.preFundMortgageIn,
                rsp.preFundMortgageOut,
                rsp.fundMortgageIn,
                rsp.fundMortgageOut,
                rsp.fundMortgageAvailable,
                rsp.mortgageableFund,
                rsp.specProductMargin,
                rsp.specProductFrozenMargin,
                rsp.specProductCommission,
                rsp.specProductFrozenCommission,
                rsp.specProductPositionProfit,
                rsp.specProductCloseProfit,
                rsp.specProductPositionProfitByAlg,
                rsp.specProductExchangeMargin,
                rsp.bizType,
                rsp.frozenSwap,
                rsp.remainSwap
            )
...
class RspOrderField(
    ...
    var orderRef: String,
    var userID: String,
    var orderPriceType: Char,
    var direction: Char,
    var combOffsetFlag: String,
    var combHedgeFlag: String,
    var limitPrice: Double,
    var volumeTotalOriginal: Int,
    var timeCondition: Char,
    var GTDDate: String,
    var volumeCondition: Char,
    var minVolume: Int,
    var contingentCondition: Char,
    var stopPrice: Double,
    var forceCloseReason: Char,
    var isAutoSuspend: Int,
    var businessUnit: String,
    var requestID: Int,
    var orderLocalID: String,
    ...
    var traderID: String,
    var installID: Int,
    var orderSubmitStatus: Char,
    var notifySequence: Int,
    var tradingDay: String,
    var settlementID: Int,
    var orderSysID: String,
    var orderSource: Char,
    var orderStatus: Char,
    var orderType: Char,
    var volumeTraded: Int,
    var volumeTotal: Int,
    ...
    var activeTraderID: String,
    var clearingPartID: String,
    var sequenceNo: Int,
    var frontID: Int,
    var sessionID: Int,
    var userProductInfo: String,
    var statusMsg: String,
    var userForceClose: Int,
    var activeUserID: String,
    var brokerOrderSeq: Int,
    var relativeOrderSysID: String,
    var ZCETotalTradedVolume: Int,
    var isSwapOrder: Int,
    var branchID: String,
    var investUnitID: String,
    var accountID: String,
    var currencyID: String,
    ...
    fun clone(): RspOrderField = RspOrderField(
        brokerID,
        investorID,
        instrumentID,
        orderRef,
    ...
    fun toActionOrderReq(): IInputOrderActionField {
        return CTPInputOrderActionField(
            brokerID,
            investorID,
            48,
            orderRef,
    ...
    companion object {
        fun fromCTPAPI(rsp: CThostFtdcOrderField?): RspOrderField? =
            if (rsp == null) null
                ...
                rsp.combHedgeFlag,
                rsp.limitPrice,
                rsp.volumeTotalOriginal,
                rsp.timeCondition,
                rsp.gtdDate,
                rsp.volumeCondition,
                rsp.minVolume,
                rsp.contingentCondition,
                rsp.stopPrice,
                rsp.forceCloseReason,
                rsp.isAutoSuspend,
                rsp.businessUnit,
                rsp.requestID,
                rsp.orderLocalID,
                ...
                rsp.activeUserID,
                rsp.brokerOrderSeq,
                rsp.relativeOrderSysID,
                rsp.zceTotalTradedVolume,
                rsp.isSwapOrder,
                rsp.branchID,
                rsp.investUnitID,
                rsp.accountID,
 ...
 * 报单响应数据
 */
data class RspOrderInsertField(
    var brokerID: String,
    var investorID: String,
    var instrumentID: String,
    var orderRef: String,
 ...
 * 撤单响应数据
 */
data class RspOrderActionField(
    var brokerID: String,
    var investorID: String,
    var orderActionRef: Int,
    var orderRef: String,
    var requestID: Int,
    var frontID: Int,
    var sessionID: Int,
 ...
 * 持仓明细数据
 */
data class RspPositionDetailField(
    var instrumentID: String,
    var brokerID: String,
    var investorID: String,
    var hedgeFlag: Char,
    ...
    var settlementID: Int,
    var tradeType: Char,
    var combInstrumentID: String,
    var exchangeID: String,
    var closeProfitByDate: Double,
    var closeProfitByTrade: Double,
    var positionProfitByDate: Double,
    var positionProfitByTrade: Double,
    var margin: Double,
    var exchangeMargin: Double,
    var marginRateByMoney: Double,
    var marginRateByVolume: Double,
    var lastSettlementPrice: Double,
    var settlementPrice: Double,
    var closeVolume: Int,
    var closeAmount: Double,
    var timeFirstVolume: Int,
    var investUnitID: String
) {
    companion object {
        fun fromCTPAPI(rsp: CThostFtdcInvestorPositionDetailField?): RspPositionDetailField? =
            if (rsp == null) null
                ...
                rsp.settlementID,
                rsp.tradeType,
                rsp.combInstrumentID,
                rsp.exchangeID,
                rsp.closeProfitByDate,
                rsp.closeProfitByTrade,
                rsp.positionProfitByDate,
                rsp.positionProfitByTrade,
                rsp.margin,
                rsp.exchMargin,
                rsp.marginRateByMoney,
                rsp.marginRateByVolume,
                rsp.lastSettlementPrice,
                rsp.settlementPrice,
                rsp.closeVolume,
                rsp.closeAmount,
                rsp.timeFirstVolume,
